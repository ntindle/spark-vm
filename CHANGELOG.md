...
- Competitor watch, 2026-09-24 mid evening: tracked set 7/8 VERIFIED NO-CHANGE (zero pricing/feature deltas), DigitalOcean Managed Agents pricing re-verified on the vendor's own Sept 22 press release ($0.044/vCPU-hour, $0.0095/GB-hour, $5 credit — matching C26; pricing subpage "Last verified 22 Sep 2026" stamp re-check still carried), boat.dev product-news surface UNVERIFIED (not located), C36/C41/C43/C44 no new moves, OpenAI Agents API Sep-10 public-beta dating re-confirmed VENDOR-VERIFIED (still public beta, no GA), **corpus folds: C45 GA-venue garnish** (onstage launch at WeAreDevelopers North America; Sandbox Kits → standard OCI images + CNCF submission commitment; Hermes first-class Kit demo) + **C26 pricing re-verified** (docs $0.05/GiB-month snapshot figure stands, syndicated $0.005 stays retired), in-lane dated 9/24: Docker GA venue, Island $400M/$6.4B (adjacent), Modal ~$15B talks (adjacent), Darktrace Signal Labs (adjacent) (#TBD).
