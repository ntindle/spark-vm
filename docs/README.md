...
| Doc | What it is |
| --- | ---------- |
| [COMPETITOR_WATCH_2026-09-23_AFTERNOON.md](COMPETITOR_WATCH_2026-09-23_AFTERNOON.md) | Competitor watch, 2026-09-23 afternoon — tracked set fully quiet (8/8 vendor re-reads, NO-CHANGE); Vercel Drives still public beta (third consecutive no-change pass, page last_updated 2026-09-10); one in-window THIRD-PARTY delta filed as investor color only (Firecrawl $75M Series B, Smash Capital-led, adds to the C32 filing); borderline pre-window color (Boxd $2M pre-seed, Alibaba FC Agent Sandbox pricing); no always-on persistent-agent-machine announcements. |
