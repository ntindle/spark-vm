...
| Doc | What it is |
| --- | ---------- |
| [COMPETITOR_WATCH_2026-09-22_NIGHT.md](COMPETITOR_WATCH_2026-09-22_NIGHT.md) | Competitor watch, 2026-09-22 night — quiet window (~17:54→~01:05 CDT), zero in-window deltas; adjacent color on Meta Muse's Sentinel per-user VM security architecture (third-party deep dive of the pre-window launch). |
