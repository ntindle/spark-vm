...
## Watch update — 2026-09-25 (midday): C26 conflict scoped (snapshots-only) + second conflict surfaced; C48 vendor-confirmed; C49 new
...
**C48 — GA vendor-confirmed, launch pricing folded.** Vendor blog
...
vendor-confirmed; pricing upgraded to vendor-sourced; the
