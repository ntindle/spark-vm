...
- **Grade upgrade vs the carried watch-only snippet:** prior passes
  ...
  vendor-primary page found), but no longer vendor-unconfirmed.
...
- It is **already corpus**: filed in the 2026-09-24 pre-midnight
  pass ("**C45 — BAND Python Kit partnership (THIRD-PARTY,
  dated)**", `docs/COMPETITOR_WATCH_2026-09-24_PRE_MIDNIGHT.md`)
...
days; marginal lane fit); Whiteboard (YC W26 agent IDE recap — IDE,
...
sandbox/runtime launches dated 2026-09-25 (the in-lane dated-9/25
items were security disclosures, a fundraise announcement read, and
